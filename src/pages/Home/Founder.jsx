...
export default function Founder() {
  ...
  // Single GPU-optimized motion stream (removes mobile RAF spam)
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-12 gap-12 items-center">
        ...
        <div className="md:col-span-5 relative group mt-12 md:mt-0">
          ...
          <motion.div style={{ y: imgY }} className="relative rounded-[2.5rem] overflow-hidden border border-white/10 aspect-[5/6] bg-panel will-change-transform">
            <img loading="lazy" src={FounderImage} alt="Founder" className="w-full h-full object-cover object-top grayscale hover:grayscale-0 transition-all duration-700" />
          </motion.div>
          <motion.div style={{ y: noteY }} className="absolute -bottom-10 -left-0 md:-left-10 glass-card p-6 md:p-8 rounded-3xl border-l-4 border-primary max-w-xs shadow-2xl will-change-transform">
